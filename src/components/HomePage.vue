...
<template>
  ...
  <section v-motion :initial="{
    ...
    <div class=" lg:px-15 lg:sticky lg:top-0 lg:w-dvw lg:h-10 lg:pt-20 lg:pb-20 pb-0 pt-10 ">
      ...
      <div class="flex justify-center md:justify-start">
        <div class="card md:mb-0 my-8 ">
          <a class="social-link1" href="https://github.com/TheWarrior0216">
    ...
    <div class="   text-slate-400 mx-0 lg:mx-0  lg:pt-20 pt-10">
      ...
      <p id="about" class="md:mb-8 mb-7">Hello! I’m Seth Baxter, a passionate software developer with excitment for
        crafting
        innovative
        and efficient
            ...
            <li v-motion :initial="{
              ...
              <div
                ...
                <div class="flex flex-col w-full">
                  <a class="lg:cursor-pointer" href="https://keepr.sethbaxter.org/#/">
                  ...
                  <p class="text-slate-400 pe-1">
                    Keepr is a website about collections and creating individual posts that you can share to a home page
                    for everyone to see. You can navigate to profile pages and view other individual vaults.
                  </p>
                  <div class="flex my-3">
                    <span
            ...
            <li v-motion :initial="{
              ...
              <div
                ...
                <div class="flex flex-col w-5/6">
                  <a class="lg:cursor-pointer" href="https://boisemenuworks.com/#/">
                    >>>>>>> 7b535a4 (Updated Template)
                  ...
                  <p class="text-slate-400 pe-2">
                    Menu Works the application created for the small buisness owner and anybody who eats food. Find a
                    local buisness that you may have never known about and order directly from your device. The small
                    buisness owner can receive orders and add there menu with ease.
                  </p>
                  <div class="flex my-3">
                    <span
